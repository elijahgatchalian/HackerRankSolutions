/*
 ...
 some of the problems posted on hackerrank.com using C++. I have provided time
...
void createUniqueScores(vector<int> &uniqueScores, const vector<int> scores){
    /*
     Purpose: Find all the unique scores in 'scores'
     Input:
...
vector<int> aliceRanks(const vector<int> uniqueScores, const vector<int> alice){
    /*
     ...
     Output: A vector of alice's ranking after each of her games
    */
    vector<int> ranks;
...
vector<int> climbingLeaderboard(vector<int> scores, vector<int> alice) {
    /*
     ...
     Output: A vector of integers of alice's ranking after each of her games
    */
...
int countingValleys(int n, string s) {
    /*
     ...
     Input:
        ...
        - s: A string of Ds and Us representing downhill/uphill steps
...
vector<int> matchingStrings(vector<string> strings, vector<string> queries) {
    /*
     ...
     Input:
        ...
        - queries: A vector of strings. No dupliate values.
...
bool has_cycle(SinglyLinkedListNode* head) {
    ...
    */
    ...
    /*
     ...
     race, the face runner will reach the end before the slow running, meaning this is not circular
    */
